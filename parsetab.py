...
_lr_productions = [
  ...
  ('statement -> FRAMES INT','statement',2,'p_statement_frames','mdl.py',140),
  ('statement -> BASENAME TEXT','statement',2,'p_statement_basename','mdl.py',144),
  ('statement -> VARY SYMBOL INT INT NUMBER NUMBER','statement',6,'p_statement_vary','mdl.py',148),
  ('statement -> POP','statement',1,'p_statement_stack','mdl.py',153),
  ('statement -> PUSH','statement',1,'p_statement_stack','mdl.py',154),
  ('statement -> SCREEN INT INT','statement',3,'p_statement_screen','mdl.py',158),
  ('statement -> SCREEN','statement',1,'p_statement_screen','mdl.py',159),
  ('statement -> SAVE','statement',1,'p_statement_save','mdl.py',166),
  ('statement -> SAVE TEXT','statement',2,'p_statement_save','mdl.py',167),
  ('statement -> DISPLAY TEXT','statement',2,'p_statement_show','mdl.py',174),
  ('statement -> DISPLAY','statement',1,'p_statement_show','mdl.py',175),
  ('statement -> SET SYMBOL NUMBER','statement',3,'p_statement_knobs','mdl.py',179),
  ('statement -> SET_KNOBS NUMBER','statement',2,'p_statement_knobs','mdl.py',180),
  ('statement -> SPHERE NUMBER NUMBER NUMBER NUMBER INT INT','statement',7,'p_statement_sphere','mdl.py',187),
  ('statement -> SPHERE NUMBER NUMBER NUMBER NUMBER','statement',5,'p_statement_sphere','mdl.py',188),
  ('statement -> TORUS NUMBER NUMBER NUMBER NUMBER NUMBER INT INT','statement',8,'p_statement_torus','mdl.py',195),
  ('statement -> TORUS NUMBER NUMBER NUMBER NUMBER NUMBER','statement',6,'p_statement_torus','mdl.py',196),
  ('statement -> BOX NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',7,'p_statement_box','mdl.py',203),
  ('statement -> LINE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',7,'p_statement_line','mdl.py',207),
  ('statement -> CIRCLE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',8,'p_statement_circle','mdl.py',211),
  ('statement -> CIRCLE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',9,'p_statement_circle','mdl.py',212),
  ('statement -> BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',14,'p_statement_curve','mdl.py',222),
  ('statement -> BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',13,'p_statement_curve','mdl.py',223),
  ('statement -> HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',14,'p_statement_curve','mdl.py',224),
  ('statement -> HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',13,'p_statement_curve','mdl.py',225),
  ('statement -> MOVE NUMBER NUMBER NUMBER SYMBOL','statement',5,'p_statement_move','mdl.py',232),
  ('statement -> MOVE NUMBER NUMBER NUMBER','statement',4,'p_statement_move','mdl.py',233),
  ('statement -> SCALE NUMBER NUMBER NUMBER SYMBOL','statement',5,'p_statement_scale','mdl.py',241),
  ('statement -> SCALE NUMBER NUMBER NUMBER','statement',4,'p_statement_scale','mdl.py',242),
  ('statement -> ROTATE XYZ NUMBER SYMBOL','statement',4,'p_statement_rotate','mdl.py',250),
  ('statement -> ROTATE XYZ NUMBER','statement',3,'p_statement_rotate','mdl.py',251),
  ('SYMBOL -> XYZ','SYMBOL',1,'p_SYMBOL','mdl.py',259),
  ('SYMBOL -> ID','SYMBOL',1,'p_SYMBOL','mdl.py',260),
  ('TEXT -> SYMBOL','TEXT',1,'p_TEXT','mdl.py',264),
  ('TEXT -> STRING','TEXT',1,'p_TEXT','mdl.py',265),
  ('NUMBER -> DOUBLE','NUMBER',1,'p_NUMBER','mdl.py',269),
  ('NUMBER -> INT','NUMBER',1,'p_NUMBER','mdl.py',270),
]
